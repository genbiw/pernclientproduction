        ...
        >
            ...
            <Modal.Body>
                <Form>
                    ...
                    <Form.Control className='mt-3' placeholder='Enter device name' value={name} onChange={e => setName(e.target.value)}/>
                    ...
                    <Button variant='outline-dark' onClick={addInfo}>Add new parametr</Button>
                    {
                        info.map(i => 
                            <Row className='mt-4' key={i.number}>
                                <Col md={4}>
                                    <Form.Control placeholder='Enter parametr name' value={i.title} onChange={e => changeInfo("title", e.target.value, i.number)}/>
                                </Col>
                                <Col md={4}>
                                    <Form.Control placeholder='Enter parametr description' value={i.description} onChange={e => changeInfo("description", e.target.value, i.number)}/>
                                </Col>
                                <Col md={4}>
